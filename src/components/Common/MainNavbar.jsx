        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link" href={`/light/home-main`}><span className="rolling-text">Home</span></Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link" href={`#`}><span className="rolling-text">About</span></Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link" href={`#`}><span className="rolling-text">Services</span></Link>
            </li>
            <li className="nav-item">
            <Link className="nav-link" href={`#`}><span className="rolling-text">Our Team</span></Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href={`#`}><span className="rolling-text">Contact</span></Link>
            </li>
          </ul>
        </div>
